	 ...
	 if (reset = '1') then
	     ...
	     if (state = "000") then
		      if (src_valid = '1') then
					...
					-- Little endian fix? 
					input_buffer_holder(idct_col_count, idct_row_count) <= src_data(23 downto 16) & src_data(31 downto 24);
					input_buffer_holder(idct_col_count, idct_row_count + 1) <=  (src_data(7 downto 0) & src_data(15 downto 8));
